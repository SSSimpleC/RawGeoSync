...
public actor ExifToolClient: MetadataTooling {
    ...
    public init(runner: any ExecutableRunning = ProcessExecutableRunner(), configuration: ExifToolConfiguration) {
        self.runner = runner
    ...
    private func parsedGPS(in object: [String: JSONValue]) throws -> (metadata: GPSMetadata?, isPartial: Bool) {
        ...
        guard let latitude, let longitude else {
            return (nil, latitude != nil || longitude != nil || rawAltitude != nil || altitudeReference != nil)
        }

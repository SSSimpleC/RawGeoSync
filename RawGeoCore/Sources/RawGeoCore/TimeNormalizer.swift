...
public struct TimeNormalizer: Sendable {
    ...
    private func uniqueDate(for timestamp: PhotoCaptureTimestamp, in timeZone: TimeZone) throws -> Date {
    ...
    private func candidateDates(for timestamp: PhotoCaptureTimestamp, in timeZone: TimeZone) throws -> [Date] {
...
private extension PhotoCaptureTimestamp {
...
private extension DateComponents {
    func matches(_ timestamp: PhotoCaptureTimestamp) -> Bool {
        year == timestamp.year
